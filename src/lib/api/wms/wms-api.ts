 ...
 */
export async function getInventorySummaries(productIds: string[]): Promise<InventorySummary[]> {
 ...
 * TODO: 실제 WMS API 연동 시 구현
 */
export async function getInventoryByVariant(productId: string): Promise<InventoryByVariant | undefined> {
