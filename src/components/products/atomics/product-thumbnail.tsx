...
export const ProductThumbnail = ({
  ...
  return (
    <div
      className={
        show
          ? "bg-muted relative aspect-square w-full overflow-hidden rounded-tl-[5px] rounded-tr-[15px] rounded-br-[15px] rounded-bl-[15px] md:rounded-[5px]"
          : "bg-muted aspect-square] relative w-full overflow-hidden rounded-[15px] md:rounded-[5px]"
      }
    >
      <Image
