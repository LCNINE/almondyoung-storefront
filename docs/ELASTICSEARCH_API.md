...
```json
{
  "nested": {
    ...
    "query": {
      "bool": {
        "must": [{ "term": { "tags.group_id": "groupId" } }, { "terms": { "tags.value_id": ["valueId1", "valueId2"] } }]
      }
    }
  }
}
  ...
  "tags_by_group": {
    ...
    "aggs": {
      "groups": {
        ...
        "aggs": {
          "group_name": { "top_hits": { "size": 1, "_source": ["tags.group_name"] } },
          "values": {
            "terms": { "field": "tags.value_id", "size": 100 },
            "aggs": {
              "value_name": { "top_hits": { "size": 1, "_source": ["tags.value_name"] } }
            }
          }
        }
      }
